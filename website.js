...
Webflow.require('ix').init([
  {"slug":"move-portfolio-icon-initial-app","name":"Move Portfolio Icon Initial  App.","value":{"style":{"opacity":0,"x":"0px","y":"50px","z":"0px"},"triggers":[]}},
  {"slug":"portfolio-overlay-on-initial-app","name":"Portfolio Overlay on Initial App.","value":{"style":{"opacity":1},"triggers":[]}},
  {"slug":"show-link-on-hover","name":"Show Link on Hover","value":{"style":{"opacity":0},"triggers":[{"type":"hover","descend":true,"stepsA":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"opacity":0,"transition":"opacity 500ms ease 0ms"}]}]}},
  {"slug":"hideim","name":"HideIm","value":{"style":{},"triggers":[{"type":"click","selector":".image-2","stepsA":[{"height":"0px","transition":"height 500ms ease 0"}],"stepsB":[]}]}},
  {"slug":"showim","name":"ShowIm","value":{"style":{},"triggers":[{"type":"click","selector":".image-2","stepsA":[{"display":"inline-block"}],"stepsB":[]}]}},
  {"slug":"new-interaction","name":"New Interaction","value":{"style":{},"triggers":[{"type":"load","stepsA":[{}],"stepsB":[]}]}},
  {"slug":"show-link-on-scroll","name":"Show link on scroll","value":{"style":{"opacity":0},"triggers":[{"type":"scroll","offsetTop":"50%","offsetBot":"50%","stepsA":[{"opacity":0,"transition":"opacity 1000ms ease 0"},{"opacity":1,"transition":"opacity 2000ms ease 0"}],"stepsB":[{"opacity":0,"transition":"opacity 2000ms ease 0"}]}]}}
]);
